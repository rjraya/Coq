...
Ltac invert_pred_unbounded P :=
  match goal with
  | H:?F _ |- _ => unify F P; inversion H
  | H:?F _ _ |- _ => unify F P; inversion H
  | H:?F _ _ _ |- _ => unify F P; inversion H
  | H:?F _ _ _ _ |- _ => unify F P; inversion H
  | H:?F _ _ _ _ _ |- _ => unify F P; inversion H
  | H:?F _ _ _ _ _ _ |- _ => unify F P; inversion H
  end.
...
Ltac strings := rewrite eqb_eq in * || rewrite eqb_neq in *.
